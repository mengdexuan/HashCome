...
public class SmsController {
    ...
    public MessageResult sendCheckCode(String phone, String country) throws Exception {
        ...
        if ("86".equals(country1.getAreaCode())) {
            ...
            log.info("send international message(code): " + randomCode);
            log.info("send international message(area code): " + country1.getAreaCode());
            log.info("send international message(phone): " + phone);
