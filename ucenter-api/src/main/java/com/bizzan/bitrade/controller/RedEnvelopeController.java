...
public class RedEnvelopeController extends BaseController{
    ...
    private MessageResult receiveEnvelope(HttpServletRequest request, String phone, String verifyCode, String promotionCode,
    	...
    	if(!memberService.phoneIsExist(phone)) {
	        ...
	        if (member != null) {
	            ...
	            memberEvent.onRegisterSuccess(member, promotionCode.trim(), ip);
	        } else {
