...
public class ExchangeRateController {
    ...
    public MessageResult getUsdCurrencyRate(@PathVariable String currency){
        MessageResult mr = new MessageResult(0,"success");
        BigDecimal rate = coinExchangeRate.getUsdCurrencyRate(currency);
        mr.setData(rate.toString());
        return mr;
    }
